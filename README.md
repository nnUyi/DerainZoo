...
* Single Image Deraining using a Recurrent Multi-scale Aggregation and Enhancement Network (2019 ICME)
   * Yang el al. Single Image Deraining using a Recurrent Multi-scale Aggregation and Enhancement Network [[paper](https://github.com/nnUyi/ReMAEN/tree/master/paper)][[code](https://github.com/nnUyi/ReMAEN)]
...
* Automatic Single-Image-Based Rain Streaks Removal via Image Decomposition (2012 TIP)
  * Li-Wei Kang et al. Automatic Single-Image-Based Rain Streaks Removal via Image Decomposition [[paper](http://www.ee.nthu.edu.tw/cwlin/Rain_Removal/tip_rain_removal_2011.pdf)][[codes](http://www.ee.nthu.edu.tw/~cwlin/pub.htm)]
